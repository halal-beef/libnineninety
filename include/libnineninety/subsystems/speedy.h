...
/* SPEEDY Register MAP */
#define SPEEDY_CTRL			0x0000
#define SPEEDY_FIFO_CTRL		0x0004
#define SPEEDY_CMD			0x0008
#define SPEEDY_INT_ENABLE		0x000C
#define SPEEDY_INT_STATUS		0x0010
#define SPEEDY_FIFO_STATUS		0x0030
#define SPEEDY_TX_DATA			0x0034
#define SPEEDY_RX_DATA			0x0038
#define SPEEDY_PACKET_GAP_TIME		0x0044
#define SPEEDY_TIMEOUT_COUNT		0x0048
#define SPEEDY_FIFO_DEBUG		0x0100
#define SPEEDY_CTRL_STATUS		0x0104
...
void speedy_write_burst(unsigned int SPEEDY_BASE, uint8_t slave, uint8_t addr,
                        uint8_t *data, uint8_t count);
void speedy_read(unsigned int SPEEDY_BASE, uint8_t slave, uint8_t addr, uint8_t *data);
void speedy_read_burst(unsigned int SPEEDY_BASE, uint8_t slave, uint8_t addr,
                       uint8_t *data, uint8_t count);
